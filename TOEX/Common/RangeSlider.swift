...
class RangeSliderTrackLayer: CALayer {
    ...
    override func draw(in ctx: CGContext) {
        ...
        let path = UIBezierPath(roundedRect: bounds.insetBy(dx: 0.0, dy: 3.0), cornerRadius: cornerRadius)
        ...
        let rect = CGRect(x: lowerValuePosition, y: 0.0, width: upperValuePosition - lowerValuePosition, height: bounds.height).insetBy(dx: 0.0, dy: 3.0)
        ctx.fill(rect)
    }
}
...
public class RangeSlider: UIControl {
    ...
    @IBInspectable public var lowerValue: Double = 0.2 {
        didSet {
            ...
            updateLayerFrames()
            delegate?.rangeSlider(self, didChangeLowerValue: lowerValue)
        }
    }
    ...
    @IBInspectable public var upperValue: Double = 0.8 {
        didSet {
            ...
            updateLayerFrames()
            delegate?.rangeSlider(self, didChangeUpperValue: upperValue)
        }
    }
